...
import { MarcadorService } from '../../../services/service.index';
...
export class RutasComponent implements OnInit {
  ...
  marcadores:Marcador[]=[];
    ...
    public origin1: Object = { lat: this.lat, lng: this.lng };
    public destination1: Object = { lat: this.lat + 0.001, lng: this.lng + 0.001 };
  ...
  constructor(private _marcadorService:MarcadorService) {
  ...
  ngOnInit() {
    this._marcadorService.cargar().subscribe((marcadores)=>{
      ...
      let nuevaRuta= new Ruta(this.marcadores['0'],this.marcadores['0']);
